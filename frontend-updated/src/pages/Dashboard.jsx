...
const Sidebar = () => {
  ...
  return (
    <aside
      id="default-sidebar"
      className="relative top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-white border-r-2"
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-white border-r-2 mt-2">
        ...
        <div class="py-2 overflow-y-auto mt-6">
...
const MainContent = () => (
  <div className="h-screen bg-main-gray basis-full ">
    <Outlet />
  </div>
);
