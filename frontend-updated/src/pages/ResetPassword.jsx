    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/auth/reset-password', {
                ...
                body: JSON.stringify({ newPassword: password , token: emailToken }), // Send email and password in request body
            });
                ...
                <div className="flex max-h-4/6 flex-1 flex-col justify-center px-6 py-6 lg:px-8">
                    ...
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="reset_password" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">Reset You Password Here </a>
                        ...
                        <div class="flex w-full max-w-sm mx-auto my-2 overflow-hidden bg-white rounded-lg shadow-md dark:bg-white-800">
                            ...
                            <div class="px-4 py-1 -mx-2">
                                <div class="mx-2">
                                    ...
                                    <a href="/" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">Login </a>
                                </div>
                            </div>
                        </div> : <></>
